...
class TagMap3DTab(DataPipelineMixin, PickingHighlightMixin, CohortLabelsMixin, VisualEffectsMixin, UIConstructionMixin, SettingsPersistenceMixin, ClientServicesMixin, QWidget):
